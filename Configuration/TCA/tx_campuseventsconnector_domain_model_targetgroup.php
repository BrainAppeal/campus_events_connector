...
$tableName = 'tx_campuseventsconnector_domain_model_targetgroup';
...
return [
    'ctrl' => [
        ...
        'searchFields' => 'name',
        'typeicon_classes' => [
            'default' => 'campus-events-targetgroup',
        ],
        'security' => [
    ...
    ImportTableConfigurationModel::TCA_IMPORT_KEY => [
        'importField' => 'TargetGroup',
        'referenceUid' => TCAUtility::IMPORT_ID_FIELD,
        'apiEndpoint' => 'target_groups',
        'apiListItemContainsAllData' => true,
        'dataTransformerClass' => DefaultDataTransformer::class,
