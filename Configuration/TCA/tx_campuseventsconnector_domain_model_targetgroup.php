    ...
    'columns' => [
        ...
        'l10n_parent' => [
            ...
            'config' => [
                ...
                'foreign_table_where' => 'AND tx_campuseventsconnector_domain_model_targetgroup.pid=###CURRENT_PID### AND tx_campuseventsconnector_domain_model_targetgroup.sys_language_uid IN (-1,0)',
            ],
        ],
        'l10n_diffsource' => [
            'config' => [
